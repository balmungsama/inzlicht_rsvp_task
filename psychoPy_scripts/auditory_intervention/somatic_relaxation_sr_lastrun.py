...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'E:\\john\\psychoPy_scripts\\auditory_intervention\\somatic_relaxation_sr.psyexp',
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    frameRemains = 0.0 + 1.216- win.monitorFramePeriod * 0.75  # most of one frame period left
