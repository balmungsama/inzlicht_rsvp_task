...
stim_dur = .050 #duration of stimulus presentation in ms
mask_dur = 0.34 #duration of the mask in ms
...
block = data.TrialHandler(nReps=2, method='sequential',
...
#        print stim_cond
        ...
        for thisStim in stim:
            ...
            frameN = -1
            continueRoutine = True
            routineTimer.add(mask_dur + stim_dur)
            # update component parameters for each repeat
